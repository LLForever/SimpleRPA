...
public class Gene {
    ...
    private static final int max_edge = 4, min_edge = 0;
    ...
    public double decode(int[] encode){
        ...
        return (double)min_edge+(double)decimalNum/Math.pow(2,14)*(max_edge-min_edge);
    }
    ...
    public int[] encode(double decimal){
        int num = (int) (((decimal-min_edge)/(max_edge-min_edge))*Math.pow(2,14));
