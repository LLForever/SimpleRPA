...
import com.simplerpa.cloudservice.entity.util.library.node.dataproc.ObjToTextNode;
import com.simplerpa.cloudservice.utils.factory.RpaNodeFactory;

public class ObjToTextNodeFactory implements RpaNodeFactory {
    private final TaskNodeDetail taskNodeDetail;

    public ObjToTextNodeFactory(TaskNodeDetail nodeDetail){
        taskNodeDetail = nodeDetail;
    }

    @Override
    public IRpaTaskNode getInstance() throws Exception {
        ObjToTextNode node = new ObjToTextNode(taskNodeDetail);
