...
import com.simplerpa.cloudservice.entity.util.library.node.aiEnhance.KeyWordExtraNode;
import com.simplerpa.cloudservice.utils.factory.RpaNodeFactory;

import java.util.LinkedHashMap;

public class KeyWordExtraNodeFactory implements RpaNodeFactory {
    private final TaskNodeDetail taskNodeDetail;

    public KeyWordExtraNodeFactory(TaskNodeDetail nodeDetail){
        taskNodeDetail = nodeDetail;
    }

    @Override
    public IRpaTaskNode getInstance() throws Exception {
        KeyWordExtraNode node = new KeyWordExtraNode(taskNodeDetail);
